terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForSerFamiliaCrianca/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForSerFamiliaCrianca"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "serfamiliacrianca"
    "Squad"          = "renda"
    "Sustain"        = "false"
    "wiz_cig"        = "true"
  }
...
module "BURoleForSerFamiliaCrianca" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForSerFamiliaCrianca",
