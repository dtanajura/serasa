terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForBolsaCapixaba/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForBolsaCapixaba"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "bolsacapixaba"
    "Squad"          = "renda"
    "Sustain"        = "false"
    "wiz_cig"        = "true"
    "version"        = "1.0.0"
...
module "BURoleForBolsaCapixaba" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForBolsaCapixaba",
