terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForGarantiaSafra/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForGarantiaSafra"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "garantiasafra"
    "Squad"          = "renda"
    "Sustain"        = "false"
    "wiz_cig"        = "true"
    "version"        = "1.0.0"
...
module "BURoleForGarantiaSafra" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForGarantiaSafra",
