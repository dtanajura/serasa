terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForTseCandidatos/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForTseCandidatos"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "tsecandidatos"
    "Squad"          = "renda"
    "Sustain"        = "false"
    "wiz_cig"        = "true"
    "version"        = "1.0.0"
...
module "BURoleForTseCandidatos" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForTseCandidatos",
