terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForServidoresPublicos/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForServidoresPublicos"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "servidorespublicos"
    "Squad"          = "renda"
    "Sustain"        = "false"
    "wiz_cig"        = "true"
    "version"        = "1.0.0"
...
module "BURoleForServidoresPublicos" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForServidoresPublicos",
