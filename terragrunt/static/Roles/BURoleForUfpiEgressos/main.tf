terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForUfpiEgressos/terraform.tfstate"
  }
}
...
module "BURoleForUfpiEgressos" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForUfpiEgressos",
