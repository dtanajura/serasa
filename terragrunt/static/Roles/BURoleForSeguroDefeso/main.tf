terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForSeguroDefeso/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForSeguroDefeso"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "segurodefeso"
    "Squad"          = "renda"
    "Sustain"        = "false"
    "wiz_cig"        = "true"
    "version"        = "1.0.0"
...
module "BURoleForSeguroDefeso" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForSeguroDefeso",
