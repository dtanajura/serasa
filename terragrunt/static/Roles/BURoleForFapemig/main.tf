terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForFapemig/terraform.tfstate"
  }
}
...
module "BURoleForFapemig" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForFapemig",
