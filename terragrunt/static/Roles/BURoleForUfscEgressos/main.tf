terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForUfscEgressos/terraform.tfstate"
  }
}
...
module "BURoleForUfscEgressos" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForUfscEgressos",
