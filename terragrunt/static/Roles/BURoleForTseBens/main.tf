terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForTseBens/terraform.tfstate"
  }
}
...
module "BURoleForTseBens" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForTseBens",
