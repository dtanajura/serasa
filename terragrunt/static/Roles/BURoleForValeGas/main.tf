terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForValeGas/terraform.tfstate"
  }
}
...
module "BURoleForValeGas" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForValeGas",
