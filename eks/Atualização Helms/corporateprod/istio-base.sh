...
# Antes da atualização precisa atualizar os CRDs
# Obter todos os CRDs com os labels relacionados ao Istio
$crds1 = kubectl get crds -l chart=istio -o name
$crds2 = kubectl get crds -l app.kubernetes.io/part-of=istio -o name
$crds = $crds1 + $crds2 | Sort-Object -Unique

# Aplicar labels e annotations em cada CRD
foreach ($crd in $crds) {
