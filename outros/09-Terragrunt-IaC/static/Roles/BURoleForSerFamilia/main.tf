terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForSerFamilia/terraform.tfstate"
  }
}
...
module "BURoleForSerFamilia" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForSerFamilia",
