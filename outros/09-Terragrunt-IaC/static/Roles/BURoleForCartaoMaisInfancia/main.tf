terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForCartaoMaisInfancia/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForCartaoMaisInfancia"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "cartaomaisinfancia"
    "Squad"          = "renda"
    "Sustain"        = "false"
    "wiz_cig"        = "true"
    "version"        = "1.0.0"
...
module "BURoleForCartaoMaisInfancia" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForCartaoMaisInfancia",
