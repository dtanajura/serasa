terraform {
  backend "s3" {
    key = "sa-east-1/iam/roles/BURoleForMultiprovider/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "Name"           = "BURoleForMultiprovider"
    "Project"        = "datahub"
    "Service"        = "latam_nike"
    "Solution"       = "multiprovider"
...
module "BURoleForMultiprovider" {
  ...
  policy_arns = [
    "arn:aws:iam::730335661246:policy/BUPolicyForMultiprovider",
