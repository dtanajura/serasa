resource "aws_dms_endpoint" "source-endpoint-notification" {
  engine_name = "docdb"
...
resource "aws_dms_endpoint" "target-endpoint-notification" {
  engine_name = "docdb"
  endpoint_type = "target"
  endpoint_id = "target-migracao-mongodb-digital-services-notification"
  database_name = "notification"
  ...
  tags = {
    Name = "target-migracao-mongodb-digital-services-notification"
  }
}
