...
Set-Location "C:\Users\c96531a\OneDrive - EXPERIAN SERVICES CORP\serasa\producao gráficos"
...
foreach ($profile_aws  in $profiles) {
    python "C:\Users\c96531a\OneDrive - EXPERIAN SERVICES CORP\serasa\producao gráficos\carrega_dados.py" $profile_aws 
}
python "C:\Users\c96531a\OneDrive - EXPERIAN SERVICES CORP\serasa\producao gráficos\geral\inventario.py"

foreach ($profile_aws  in $profiles) {
    python .\inventario.py $profile_aws 
}

foreach ($profileaws  in $profiles) {
    aws ce list-cost-allocation-tags --profile $profile_aws 
}
